...
const loaderImage = `
  <?xml version="1.0" encoding="UTF-8" standalone="no"?><svg xmlns:svg="http://www.w3.org/2000/svg"
    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" width="160px"
    height="20px" viewBox="0 0 128 16" xml:space="preserve">
    <path fill="#fac2be" fill-opacity="0.42"
    ...
    <g>
      <path fill="#f26d64" fill-opacity="1"
      ...
      <animateTransform attributeName="transform" type="translate"
        values="23 0;36 0;49 0;62 0;74.5 0;87.5 0;100 0;113 0;125.5 0;138.5 0;151.5 0;164.5 0;178 0" calcMode="discrete"
        dur="1430ms" repeatCount="indefinite" />
    </g>
  </svg>
`;

const Preloader = styled.section`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
export default () => {
  return <Preloader>{loaderImage}</Preloader>;
};
